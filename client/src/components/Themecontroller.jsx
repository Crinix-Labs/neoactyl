...
const ThemeController = () => {
  ...
  return (
    <>
      <div className="dropdown mb-72 fixed top-4 left-6">
        ...
        <ul tabIndex={0} data-choose-theme className="dropdown-content bg-base-300 rounded-box z-1 w-52 p-2 shadow-2xl">
          {themes.map((theme) => (
            <li key={theme.value}>
              <input
                type="radio"
